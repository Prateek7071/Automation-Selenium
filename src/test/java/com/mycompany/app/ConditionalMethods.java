...
public class ConditionalMethods {
 public static void main(String[] args) {
     ...
     WebElement newsLetterStatusE = driver.findElement(By.xpath("//input[@id='NewsLetterSubscriptions_0__IsActive']"));
     newsLetterStatusE.click();
     boolean newsLetterStatus= newsLetterStatusE.isSelected();
